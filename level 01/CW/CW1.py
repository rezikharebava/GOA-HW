...
#"rezi" არის ცვლადისთვის მნიშვნელობა

surname = "kharebava"

# print(name)
#პრინტ ფუნქცია გადაეცემა ეკრანზე გამოსატანი ობიექტი

name = "rezi" # ეს არის str (string) ტიპის ცვლადი
...
siUgly = False #ჯავასკრიპტული camelcase
